...
public class StartupConstants {
    ...
    public static String PATH_CSS = "/epf/style/";
    public static String STYLE_SHEET_UI_Y = PATH_CSS + "EPortFolioStyle_Y.css";
    public static String STYLE_SHEET_UI_B = PATH_CSS + "EPortFolioStyle_B.css";
    public static String STYLE_SHEET_UI_BL = PATH_CSS + "EPortFolioStyle_BL.css";
    public static String STYLE_SHEET_UI_G = PATH_CSS + "EPortFolioStyle_G.css";
    public static String STYLE_SHEET_UI_R = PATH_CSS + "EPortFolioStyle_R.css";
    ...
    public static String ICON_PAGEADD = "pageAdd.png";
    public static String ICON_PAGEREMOVE = "pageRemove.png";
    public static String ICON_LOAD_SLIDE_SHOW = "Load.png";
    public static String ICON_SAVE_SLIDE_SHOW = "Save.png";
    public static String ICON_SAVEAS_SLIDE_SHOW = "SaveAs.png";
    ...
    public static String ICON_SITE_VIEW = "View.png";
    public static String ICON_VIEW = "View2.png";
    public static String ICON_EDIT = "Edit.png";
    public static String ICON_IMAGE = "Images.png";
    ...
    public static String ICON_ONE = "One.png";
    public static String ICON_TWO = "Two.png";
    public static String ICON_THREE = "Three.png";
    public static String ICON_FOUR = "Four.png";
    public static String ICON_FIVE = "Five.png";
    ...
    public static String    CSS_CLASS_FONT = "text";
