...
import static epf.StartupConstants.CSS_CLASS_CAPTION_PROMPT;
import static epf.StartupConstants.CSS_CLASS_CAPTION_TEXT_FIELD;
import static epf.StartupConstants.CSS_CLASS_SLIDE_EDIT_VIEW;
import static epf.StartupConstants.DEFAULT_THUMBNAIL_WIDTH;
import epf.controller.ImageSelectionController;

import epf.error.ErrorHandler;
import static epf.file.EPortFolioFileManager.SLASH;
 ...
 */
public class EPortFolioEditView extends HBox {
     ...
     */
    public EPortFolioEditView(EPortFolioMakerView initUi, EPortFolio initPortfolio) {
	// KEEP THIS FOR LATER
	ui = initUi;
	...
	captionTextField.setText(portfolio.getCaption());
	...
	String imagePath = portfolio.getImagePath() + SLASH + portfolio.getImageFileName();
